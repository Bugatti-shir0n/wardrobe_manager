<template>
    <div class="wardrobe-container">
      <h1>
        <i class="fas fa-tshirt"></i> Welcome to your wardrobe manager
      </h1>
  ...
  const products = ref([
    { id: 1, name: 'Official', category: 'Suits', price: 70, image: '/outfit1.jpeg' },
    { id: 2, name: 'Smart casual', category: 'Pants', price: 34, image: '/outfit3.jpg' },
    { id: 3, name: 'Sneaker', category: 'Shoes', price: 98, image: '/shoe.jpg' },
    { id: 4, name: 'Sunny pants', category: 'Pants', price: 23, image: '/shoes.jpeg' },
    { id: 5, name: 'It girl', category: 'Suits', price: 99, image: '/jeans.jpeg' }
  ...
  const editProduct = (product) => {
    ...
    const updatedPrice = prompt('Edit price ($):', product.price);
