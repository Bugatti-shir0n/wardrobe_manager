<template>
  <div class="products-container">
    ...
    <div class="overview">
      ...
      <div class="overview-item">
        <i class="fas fa-plus"></i> Whats New:
...
const products = ref([
  { id: 1, name: 'Smart sasual', category: 'Pants', price: 79, size: 'M', image: '/outfit3.jpg' },
  { id: 2, name: 'Sunny pants', category: 'Pants', price: 35, size: 'L', image: '/shoes.jpeg' },
  { id: 3, name: 'It girl', category: 'Suits', price: 76, size: 'S', image: '/jeans.jpeg' },
]);
